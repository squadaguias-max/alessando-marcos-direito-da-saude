...
export function Footer() {
  return <footer><div className="container footer-inner">
    ...
    <div className="footer-contacts"><a href={whatsappUrl()} target="_blank" rel="noreferrer"><MessageCircle />{site.contact.phoneLabel}</a><a href={whatsappUrl(undefined, true)} target="_blank" rel="noreferrer"><MessageCircle />{site.contact.phoneSecondaryLabel}</a><a href={`mailto:${site.contact.email}`}><Mail />{site.contact.email}</a><span><MapPin />{site.office.district}</span></div>
