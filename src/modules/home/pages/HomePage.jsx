...
function CTA({ children = "Quero analisar meu caso", secondary = false }) { return <a className="primary-button" href={whatsappUrl(undefined, secondary)} target="_blank" rel="noreferrer"><MessageCircle />{children}<ArrowRight /></a>; }
...
export function HomePage() {
  ...
  return <>
    ...
    <section className="light-section process-section" id="processo"><div className="container"><header className="section-heading"><span className="eyebrow">Etapas do atendimento</span><h2>Como funciona?</h2><p>Um processo simples, transparente e direcionado às particularidades do seu caso.</p></header><div className="steps"><article><span>01</span><MessageCircle /><h3>Entre em contato</h3><p>Fale com nossa equipe por um dos canais de WhatsApp.</p></article><article><span>02</span><FileCheck2 /><h3>Envie sua documentação</h3><p>Analisaremos prescrição, laudos, exames e a negativa, quando houver.</p></article><article><span>03</span><ShieldCheck /><h3>Receba uma análise jurídica</h3><p>Avaliamos o caso e orientamos sobre as possibilidades previstas na legislação.</p></article></div></div></section>
    ...
    <div className="floating-group"><a className="floating-whatsapp secondary" href={whatsappUrl(undefined, true)} target="_blank" rel="noreferrer" aria-label={`WhatsApp ${site.contact.phoneSecondaryLabel}`}><MessageCircle /><span>{site.contact.phoneSecondaryLabel}</span></a><a className="floating-whatsapp" href={whatsappUrl()} target="_blank" rel="noreferrer" aria-label={`WhatsApp ${site.contact.phoneLabel}`}><MessageCircle /><span>{site.contact.phoneLabel}</span></a></div>
  </>;
}
